        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item"><b>Відгуків:</b> <span>${card.price}</span></li>
                    <li class="list-group-item"><b>Ціна:</b> <span>${card.reviews}₴</span></li>
                </ul>
            </div>
...
function showProdsInCart(){
    let cart_length = getCartProducts().length;
    document.getElementById(`prod_in_card`).innerText = `(${cart_length})`;
